...
class QRencode {
    ...
    //----------------------------------------------------------------------
    public static function factory($level = Constants::QR_ECLEVEL_L, $size = 3, $margin = 4, $back_color = 0x0013FF, $fore_color = 0x000000, $cmyk = false)
    {
        $enc = new QRencode();
        $enc->size = $size;
        $enc->margin = $margin;
